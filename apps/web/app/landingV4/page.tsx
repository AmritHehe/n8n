...
export default function LandingV4() {
    ...
    const go = () => router.push(isLoggedIn ? "/landingV4/workflows" : "/landingV4/signup");
        ...
        <main ref={containerRef} className="relative min-h-screen w-full bg-[#08080c] text-white antialiased selection:bg-blue-400/20 overflow-x-hidden">
                ...
                <div className="mx-auto max-w-6xl px-6">
                    <div className="mt-5 flex items-center justify-between rounded-full border border-white/5 bg-[#08080c]/70 backdrop-blur-2xl px-6 py-3">
                        ...
                        <div className="hidden md:flex items-center gap-4">
                            <Link href="/landingV4/signin" className="text-[12px] text-white/30 hover:text-white/60 transition-colors">
                                Sign in
                            </Link>
                            <button
                                onClick={go}
                    ...
                    {menuOpen && (
                        <div className="md:hidden mt-2 rounded-2xl border border-white/5 bg-[#0c0c12]/95 backdrop-blur-2xl p-6 space-y-4">
                            <Link href="/landingV4/signin" className="block text-sm text-white/40">Sign in</Link>
            ...
            <section className="relative min-h-[100dvh] flex flex-col items-center justify-center text-center px-6 overflow-hidden">
                ...
                >
                    ...
                    <span className="italic bg-gradient-to-r from-blue-300 via-blue-400 to-blue-300 bg-clip-text text-transparent">
                        trigger
                    </span>
                </h1>
                ...
                >
                    ...
                    <section className="relative min-h-[80vh] flex items-center justify-center px-6 py-20">
                        <div className="text-center max-w-2xl mx-auto">
                            ...
                            <h2 className="font-ed text-4xl md:text-[3.5rem] text-white/90 leading-[1.1] mb-4">
                                Ready to <em className="italic bg-gradient-to-r from-blue-300 to-blue-400 bg-clip-text text-transparent">automate?</em>
                            </h2>
                    ...
                    <footer className="relative py-24 overflow-hidden">
                        <div className="max-w-5xl mx-auto px-6">
                            ...
                            <div className="h-[1px] bg-white/4 mb-8" />
